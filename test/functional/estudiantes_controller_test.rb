...
class EstudiantesControllerTest < ActionController::TestCase
  ...
  test "should create estudiante" do
    assert_difference('Estudiante.count') do
      post :create, estudiante: { cedula: @estudiante.cedula, direccion: @estudiante.direccion, email: @estudiante.email, fch_nacimineto: @estudiante.fch_nacimineto, nombre: @estudiante.nombre }
    end
  ...
  test "should update estudiante" do
    put :update, id: @estudiante, estudiante: { cedula: @estudiante.cedula, direccion: @estudiante.direccion, email: @estudiante.email, fch_nacimineto: @estudiante.fch_nacimineto, nombre: @estudiante.nombre }
    assert_redirected_to estudiante_path(assigns(:estudiante))
  end
