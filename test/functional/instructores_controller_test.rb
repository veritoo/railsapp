...
class InstructoresControllerTest < ActionController::TestCase
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post :create, instructor: { cedula: @instructor.cedula, direccion: @instructor.direccion, email: @instructor.email, fch_ncto: @instructor.fch_ncto, modalidad: @instructor.modalidad, nombres: @instructor.nombres, telefono: @instructor.telefono }
    end
  ...
  test "should update instructor" do
    put :update, id: @instructor, instructor: { cedula: @instructor.cedula, direccion: @instructor.direccion, email: @instructor.email, fch_ncto: @instructor.fch_ncto, modalidad: @instructor.modalidad, nombres: @instructor.nombres, telefono: @instructor.telefono }
    assert_redirected_to instructor_path(assigns(:instructor))
  end
